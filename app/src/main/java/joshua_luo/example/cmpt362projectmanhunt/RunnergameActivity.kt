...
class RunnerGameActivity : FragmentActivity(), OnMapReadyCallback {
    ...
    private fun showAbilityDialog() {
        ...
        cardAbility1.setOnClickListener {
            updateCardSelection(cardAbility1, 0)
        }

        cardAbility2.setOnClickListener {
            updateCardSelection(cardAbility2, 1)
        }

        cardAbility3.setOnClickListener {
            updateCardSelection(cardAbility3, 2)
        }
